...
I am heavily indebted to [Understanding Diffusion Models: A Unified Perspective](https://calvinyluo.com/2022/08/26/diffusion-tutorial.html) by Calvin Luo <d-cite key="https://doi.org/10.48550/arxiv.2208.11970"></d-cite> for the presentation of the DDPM math and [The Annotated Diffusion Model](https://huggingface.co/blog/annotated-diffusion) by Niels Rogge and Kashif Rasul <d-cite key="Rogge2022annotated"></d-cite> for learning about how to implement a DDPM. Be sure to check out those posts!
...
The most commonly used metrics to evaluate the sample quality of a generative image model are listed below. These metrics tend to correspond well with human judgment, but are not considered "gold standard" and finding better sample quality metrics is still an open research question. <d-cite key="https://doi.org/10.48550/arxiv.2105.05233"></d-cite>
...
The FID is considered the standard metric for evaluating generated sample quality as the time of writing. <d-cite key="https://doi.org/10.48550/arxiv.2105.05233"></d-cite> However, as noted above, it is not considered the "gold standard", and there is ongoing research into developing better sample quality metrics.
